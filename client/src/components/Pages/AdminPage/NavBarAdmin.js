        ...
        <>
            <Row className='admin-link'>
                <Link to={'/admin-panel'} className='admin-brand'>
                    ...
                    </svg>{' '}Panel de Administrador
                </Link>
            </Row>

            <Row className='admin-link'>
                <Link to={`/lista-bicis/`} className='btn btn-outline-info' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={`/lista-tiendas/`} className='btn btn-outline-info' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={'/stock'} className='btn btn-outline-info' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={`/lista-clientes`} className='btn btn-outline-info' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={'/ventas'} className='btn btn-outline-info' variant="outline-info">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-cart-check" viewBox="0 0 16 16">
