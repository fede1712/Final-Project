...
export default function NavBarAdmin() {
    return (
        <>
            ...
            <Row className='admin-link'>
                <Link to={`/lista-bicis/`} className='admin-link-setup' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={`/lista-tiendas/`} className='admin-link-setup' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={'/stock'} className='admin-link-setup' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={`/lista-clientes`} className='admin-link-setup' variant="outline-info">
            ...
            <Row className='admin-link'>
                <Link to={'/ventas'} className='admin-link-setup' variant="outline-info">
