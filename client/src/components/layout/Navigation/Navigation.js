                    ...
                    <Nav>
                        {props.loggedUser?.role === 'US' &&
                            ...
                            <>
                                ...
                                <Link className="nav-link iconCss scrollto" to="/carrito"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" className="bi bi-cart-fill" viewBox="0 0 16 16">
