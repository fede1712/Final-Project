            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav className="me-auto">
                        {/*  */}
                        <Nav.Link as={Link} to="/614f04dfd96dd8ef1bbb3fc6"><span class="navSpan">Tricycle 3</span></Nav.Link>
                    ...
                    <Nav>
                        {props.loggedUser?.role === 'US' &&
                            ...
                            <>
                                ...
                                <span className="nav-link iconCss scrollto" onClick={logout}><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                                    <path d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z" />
                                </svg> Logout</span>

                                <Link className="nav-link iconCss scrollto" to="/perfil"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                                </svg> Mi perfil</Link>

                                <Link className="nav-link iconCss scrollto" to="/carrito"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
                        ...
                        {props.loggedUser?.role === 'AD' &&
                            <>
                                ...
                                <Link className="nav-link iconCss scrollto" to="/admin-panel"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-tools" viewBox="0 0 16 16">
                        ...
                        {props.loggedUser === null &&
                            <>
                                <Link className="nav-link iconCss scrollto" to="/registro"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                    <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                                    <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z" />
                                </svg> Registro</Link>
                                <Link className="nav-link iconCss scrollto" to="/iniciar-sesion"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-check-fill" viewBox="0 0 16 16">
