                        ...
                        <ul className="nav flex-column">
                            ...
                            <li className="nav-item">
                                <div className="rrss">
                                    ...
                                    <a className="nav-link" href="#"><i className="fas fa-comments"></i>Facebook</a>
                                </div>
                            </li>
                            <div className="rrss">
                                ...
                                <a className="nav-link" href="#"><i className="fas fa-comments"></i>Instagram</a>
                            </div>
                            <div className="rrss">
                                ...
                                <a className="nav-link" href="#"><i className="fas fa-comments"></i>Twitter</a>
                            </div>
                        </ul>
                    </div>
